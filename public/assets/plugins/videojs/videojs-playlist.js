...
(function (global, factory) {
    ...
    var setup = function setup(player, delay) {
        ...
        player.playlist.autoadvance_.trigger = function () {
            player.playlist.autoadvance_.timeout = window_1.setTimeout(
                function () {
                    reset(player);
    ...
    var sourceEquals = function sourceEquals(source1, source2) {
        ...
        if (
            (typeof source1 === "undefined"
                ? "undefined"
                : _typeof(source1)) === "object"
        ) {
            src1 = source1.src;
        }
        if (
            (typeof source2 === "undefined"
                ? "undefined"
                : _typeof(source2)) === "object"
        ) {
            src2 = source2.src;
        }
        ...
        assign(playlist, {
            ...
            currentItem: function currentItem(index) {
                if (
                    ...
                    playlist.currentIndex_ = playlist.indexOf(
                        playlist.player_.currentSrc() || ""
                    );
                }

!(function (t, e) {
    ...
    function r(t) {
        ...
        return Object.assign
            ? Object.assign.apply(Object, [t].concat(r))
    ...
    function o(t) {
        return (
            i(t) && "[object Object]" === Be.call(t) && t.constructor === Object
        );
    }
    function s(t) {
        return t.replace(/\n\r?\s*/g, "");
        ...
        return (
            Object.getOwnPropertyNames(e).forEach(function (t) {
                ...
                -1 !== t.indexOf("aria-") || "role" === t || "type" === t
                    ? (ze.warn(Xe(qe, t, n)), i.setAttribute(t, n))
                    : "textContent" === t
                    ? v(i, n)
                    : (i[t] = n);
            }),
    ...
    function g(t, e) {
        return (
            c(e), t.classList ? t.classList.contains(e) : u(e).test(t.className)
        );
    }
    function m(t, e) {
        return (
            t.classList
                ? t.classList.add(e)
                : g(t, e) || (t.className = (t.className + " " + e).trim()),
            t
        );
    }
    function _(t, e) {
    ...
    function b(t, e, n) {
        var r = g(t, e);
        if (
            ("function" == typeof n && (n = n(t, e)),
            "boolean" != typeof n && (n = !r),
            n !== r)
        )
            return n ? m(t, e) : _(t, e), t;
    }
    function T(t, e) {
    ...
    function L(t) {
        var e = t[Qe];
        return e || (e = t[Qe] = R()), Je[e] || (Je[e] = {}), Je[e];
    }
    function B(t) {
        var e = t[Qe];
        ...
        if (!t || !t.isPropagationStopped) {
            ...
            for (var i in r)
                "layerX" !== i &&
                    ...
                    "webkitMovementX" !== i &&
                    "webkitMovementY" !== i &&
                    (("returnValue" === i && r.preventDefault) ||
                        (t[i] = r[i]));
            if (
                (t.target || (t.target = t.srcElement || ce),
                t.relatedTarget ||
                    (t.relatedTarget =
                        t.fromElement === t.target
                            ? t.toElement
                            : t.fromElement),
    ...
    function rt(t, e) {
        ...
        for (var o = 0; o < t.length; o++)
            (r = t.start(o)), (i = t.end(o)), i > e && (i = e), (n += i - r);
        return n / e;
    }
    function it(t) {
        ...
        "number" == typeof t
            ...
            ? (this.message = t)
            : i(t) &&
              ("number" == typeof t.code && (this.code = t.code), r(this, t)),
            this.message ||
                (this.message = it.defaultMessages[this.code] || "");
    }
    function ot(t, e) {
        var n,
            r = null;
    ...
    function vt(t) {
        ...
        function n() {
            var t = void 0;
            if (((t = a.response ? a.response : a.responseText || yt(a)), y))
                try {
                    t = JSON.parse(t);
                } catch (t) {}
            return t;
                    ...
                    0 !== e
                        ? ((r = {
                          ...
                          a.getAllResponseHeaders &&
                              (r.headers = ar(a.getAllResponseHeaders())))
        ...
        a ||
            (a =
                t.cors || t.useXDR
                    ? new ft.XDomainRequest()
                    : new ft.XMLHttpRequest());
        var l,
            c,
            u,
            h = (a.url = t.uri || t.url),
        ...
        else if (t.headers && !pt(t.headers))
            throw new Error(
    ...
    function Ct(t, e, n) {
        ...
        var o = t;
        if ((i(), (e.startTime = r()), i(), "--\x3e" !== t.substr(0, 3)))
            throw new mt(
                mt.Errors.BadTimeStamp,
    ...
    function kt(t, e) {
        ...
        for (
            var r, i = t.document.createElement("div"), o = i, s = [];
            null !==
            (r = (function () {
                if (!e) return null;
                var t = e.match(/^([^<]*)(<[^>]+>?)?/);
            ...
            if ("<" !== r[0])
                o.appendChild(
                    t.document.createTextNode(
                        (function (t) {
                            for (
                                ;
                                (c = t.match(/&(amp|lt|gt|lrm|rlm|nbsp);/));
                ...
                if ("/" === r[1]) {
                    s.length &&
                        s[s.length - 1] === r.substr(2).replace(">", "") &&
                ...
                if (l) {
                    (a = t.document.createProcessingInstruction(
                        "timestamp",
                        l
                    )),
                        o.appendChild(a);
                ...
                if (
                    !(function (t, e) {
                        return (
                            !Sr[e.localName] || Sr[e.localName] === t.localName
                        );
                    })(o, a)
                )
                    continue;
    ...
    function Pt(t, e, n, r) {
        ...
        if (o.snapToLines) {
            ...
            var c = i.lineHeight,
                ...
                p = a[0];
            Math.abs(u) > h &&
                ((u = u < 0 ? -1 : 1), (u *= Math.ceil(h / c) * c)),
                s < 0 &&
                    ((u += "" === o.vertical ? n.height : n.width),
                    (a = a.reverse())),
                i.move(p, u);
        } else {
    ...
    function Zt(t, e, n) {
        ...
        if ("string" == typeof t) {
            var o = Zt.getPlayers();
            if ((0 === t.indexOf("#") && (t = t.slice(1)), o[t]))
                return (
                    e &&
                        ze.warn(
                            'Player "' +
        ...
        if (r.player || so.players[r.playerId])
            return r.player || so.players[r.playerId];
        (e = e || {}),
            Zt.hooks("beforesetup").forEach(function (t) {
                var n = t(r, Q(e));
                if (!i(n) || Array.isArray(n))
                    return void ze.error(
        ...
        var s = bn.getComponent("Player"),
            a = new s(r, e, n);
        return (
            Zt.hooks("setup").forEach(function (t) {
                return t(a);
            }),
            a
        );
    ...
    var re,
        ie = te,
        oe = {},
        se = (Object.freeze || Object)({ default: oe }),
        ae = (se && oe) || se,
        le = void 0 !== ne ? ne : "undefined" != typeof window ? window : {};
    "undefined" != typeof document
        ? (re = document)
        : (re = le["__GLOBAL_DOCUMENT_CACHE@4"]) ||
          (re = le["__GLOBAL_DOCUMENT_CACHE@4"] = ae);
    var ce = re,
        ...
        Pe =
            h() &&
            ("ontouchstart" in ie ||
                (ie.DocumentTouch && ie.document instanceof ie.DocumentTouch)),
        Ne =
            h() && "backgroundSize" in ie.document.createElement("video").style,
            ...
            s &&
                ...
                (n &&
                    (e = e
                        ...
                        .join(" ")),
                s.apply
                    ? s[Array.isArray(e) ? "apply" : "call"](ie.console, e)
                    : s(e));
        };
    (Ve = function () {
            ...
            off: function (t, e, n) {
                if (!t || pn(t)) z(this.eventBusEl_, t, e);
                    ...
                    dn(r),
                        ...
                        this.off("dispose", n),
                        r.nodeName
                            ? (z(r, i, n), z(r, "dispose", n))
                            : hn(r) && (r.off(i, n), r.off("dispose", n));
                }
            },
            ...
            setState: function (t) {
                ...
                return (
                    e(t, function (t, e) {
                        n.state[e] !== t &&
                            ((r = r || {}),
                            (r[e] = { from: n.state[e], to: t })),
                            (n.state[e] = t);
                    }),
                    r &&
                        hn(this) &&
                        this.trigger({ changes: r, type: "statechanged" }),
                    r
                );
            },
        },
            ...
            function t(e, n, r) {
                if (
                    ...
                    !e && this.play
                        ? (this.player_ = e = this)
                        : (this.player_ = e),
                    (this.options_ = Q({}, this.options_)),
                    (n = this.options_ = Q(this.options_, n)),
                ...
                (this.name_ = n.name || null),
                    n.el
                        ? (this.el_ = n.el)
                        : !1 !== n.createEl && (this.el_ = this.createEl()),
            ...
            return (
                ...
                (t.prototype.options = function (t) {
                    return (
                        ...
                        t
                            ? ((this.options_ = Q(this.options_, t)),
                              this.options_)
                            : this.options_
                    );
                }),
                ...
                (t.prototype.addChild = function (e) {
                    ...
                    if (
                        (this.children_.splice(r, 0, i),
                        "function" == typeof i.id &&
                            (this.childIndex_[i.id()] = i),
                        (o = o || (i.name && $(i.name()))),
                ...
                (t.prototype.removeChild = function (t) {
                    if (
                        ...
                        for (
                            var e = !1, n = this.children_.length - 1;
                            n >= 0;
                            n--
                        )
                ...
                (t.prototype.setTimeout = function (t, e) {
                    ...
                    return (
                        (r.guid = "vjs-timeout-" + n), this.on("dispose", r), n
                    );
                }),
                (t.prototype.clearTimeout = function (t) {
                    ...
                    var e = function () {};
                    return (
                        (e.guid = "vjs-timeout-" + t), this.off("dispose", e), t
                    );
                }),
                (t.prototype.setInterval = function (t, e) {
                    ...
                    return (
                        (r.guid = "vjs-interval-" + n), this.on("dispose", r), n
                    );
                }),
                ...
                (t.prototype.requestAnimationFrame = function (t) {
                    ...
                    if (this.supportsRaf_) {
                        ...
                        return (
                            (r.guid = "vjs-raf-" + n), this.on("dispose", r), n
                        );
                    }
                ...
                (t.prototype.cancelAnimationFrame = function (t) {
                    if (this.supportsRaf_) {
                        ...
                        var e = function () {};
                        return (
                            (e.guid = "vjs-raf-" + t), this.off("dispose", e), t
                        );
                    }
    ...
    (bn.prototype.supportsRaf_ =
        "function" == typeof ie.requestAnimationFrame &&
        "function" == typeof ie.cancelAnimationFrame),
    ...
    for (var xn = 0; xn < it.errorTypes.length; xn++)
        (it[it.errorTypes[xn]] = xn), (it.prototype[it.errorTypes[xn]] = xn);
    var jn = ot,
        An = function (t) {
            return [
                "kind",
        ...
        On = { textTracksToJson: Pn, jsonToTextTracks: Nn, trackToJson_: An },
        Mn = "vjs-modal-dialog",
        In = (function (t) {
            function e(n, r) {
                Ie(this, e);
            ...
            return (
                ...
                (e.prototype.opened = function (t) {
                    return (
                        "boolean" == typeof t && this[t ? "open" : "close"](),
                        this.opened_
                    );
                }),
                ...
                (e.prototype.conditionalFocus_ = function () {
                    ...
                    (this.previouslyActiveEl_ = null),
                        (e.contains(t) || e === t) &&
                            ...
                            this.focus(),
                            this.on(ce, "keydown", this.handleKeyDown));
                }),
                ...
                (e.prototype.focusableEls_ = function () {
                    ...
                    return Array.prototype.filter.call(t, function (t) {
                        return (
                            ((t instanceof ie.HTMLAnchorElement ||
                                t instanceof ie.HTMLAreaElement) &&
                                t.hasAttribute("href")) ||
                            ((t instanceof ie.HTMLInputElement ||
                                t instanceof ie.HTMLSelectElement ||
                                t instanceof ie.HTMLTextAreaElement ||
                                t instanceof ie.HTMLButtonElement) &&
                                !t.hasAttribute("disabled")) ||
                            t instanceof ie.HTMLIFrameElement ||
                            t instanceof ie.HTMLObjectElement ||
                            t instanceof ie.HTMLEmbedElement ||
    ...
    (In.prototype.options_ = { pauseOnOpen: !0, temporary: !0 }),
        ...
        function e() {
            ...
            if (!i && ((i = o), Se)) {
                ...
                for (var s in e.prototype)
                    "constructor" !== s && (i[s] = e.prototype[s]);
            }
            (i.tracks_ = []),
    ...
    var Ln = function (t, e) {
        ...
        Bn = (function (t) {
            function e() {
                ...
                if (Se) {
                    ...
                    for (var a in Dn.prototype)
                        "constructor" !== a && (o[a] = Dn.prototype[a]);
                    for (var l in e.prototype)
                        "constructor" !== l && (o[l] = e.prototype[l]);
                }
                return (
                    (o = n = Re(this, t.call(this, i, o))),
                    (o.changing_ = !1),
                    (r = o),
                    Re(n, r)
                );
        ...
        Hn = (function (t) {
            function e() {
                ...
                if (Se) {
                    o = ce.createElement("custom");
                    for (var s in Dn.prototype)
                        "constructor" !== s && (o[s] = Dn.prototype[s]);
                    for (var a in e.prototype)
                        "constructor" !== a && (o[a] = e.prototype[a]);
                }
                return (
                    (o = n = Re(this, t.call(this, i, o))), (r = o), Re(n, r)
                );
            }
            return (
                De(e, t),
        ...
        Wn = (function () {
            function t() {
                ...
                if (Se) {
                    ...
                    for (var r in t.prototype)
                        "constructor" !== r && (n[r] = t.prototype[r]);
                }
                (n.trackElements_ = []),
            ...
            return (
                ...
                (t.prototype.getTrackElementByTrack_ = function (t) {
                    for (
                        var e = void 0, n = 0, r = this.trackElements_.length;
                        n < r;
                        n++
                    )
        ...
        Kn = { disabled: "disabled", hidden: "hidden", showing: "showing" },
        Gn = (function (t) {
            function e() {
                var n,
                    r =
        ...
        Qn = function (t) {
            var e = ie.location,
                n = Yn(t);
            return (
                (":" === n.protocol ? e.protocol : n.protocol) + n.host !==
                e.protocol + e.host
            );
        },
    ...
    (ft.XMLHttpRequest = ie.XMLHttpRequest || gt),
        (ft.XDomainRequest =
            "withCredentials" in new ft.XMLHttpRequest()
                ? ft.XMLHttpRequest
                : ie.XDomainRequest),
        (function (t, e) {
    ...
    var hr = function (t, e) {
            var n = new ie.WebVTT.Parser(
                    ie,
                    ie.vttjs,
                    ie.WebVTT.StringDecoder()
                ),
                r = [];
            (n.oncue = function (t) {
                e.addCue(t);
                ...
                r.length > 0 &&
                    (ie.console &&
                        ...
                        ie.console.groupCollapsed(
                            "Text Track parsing errors for " + e.src
                        ),
        ...
        pr = function (t, e) {
            ...
            r && (n.cors = r),
                ur(
                    n,
                    ln(this, function (t, n, r) {
                        if (t) return ze.error(t, n);
                        if (
                            ((e.loaded_ = !0), "function" != typeof ie.WebVTT)
                        ) {
                            if (e.tech_) {
                                var i = function () {
                                    return hr(r, e);
        ...
        dr = (function (t) {
                ...
                return (
                    ...
                    Object.defineProperty(l, "activeCues", {
                        get: function () {
                            ...
                            if (
                                ((p = !1), e.length !== this.activeCues_.length)
                            )
                                p = !0;
                            else
                                for (var o = 0; o < e.length; o++)
                                    -1 === this.activeCues_.indexOf(e[o]) &&
                                        (p = !0);
                            return (
                                (this.activeCues_ = e),
            ...
            return (
                ...
                (e.prototype.addCue = function (t) {
                    ...
                    for (
                        var r = this.tech_.textTracks(), i = 0;
                        i < r.length;
                        i++
                    )
                        r[i] !== this && r[i].removeCue(e);
                ...
                (e.prototype.removeCue = function (t) {
                    for (var e = this.cues_.length; e--; ) {
                        ...
                        if (
                            n === t ||
                            (n.originalCue_ && n.originalCue_ === t)
                        ) {
    ...
    (mr.prototype.allowedEvents_ = { load: "load" }),
        (mr.NONE = yr),
        (mr.LOADING = 1),
        (mr.LOADED = gr),
        (mr.ERROR = 3);
        ...
        (At.prototype.intersectPercentage = function (t) {
            return (
                (Math.max(
                    ...
                    Math.max(
                        0,
                        Math.min(this.bottom, t.bottom) -
                            Math.max(this.top, t.top)
                    )) /
                ...
                function n(t) {
                    ...
                    if (
                        ...
                        (n.width = e.get("width", 100)),
                            ...
                            i.regionList.push({ id: e.get("id"), region: n });
                    }
                }
                function r(t) {
                    var e = new bt();
    ...
    var jr = Nt,
        Ar = "auto",
        Pr = { "": !0, lr: !0, rl: !0 },
        Nr = { start: !0, middle: !0, end: !0, left: !0, right: !0 };
            ...
            function e() {
                ...
                return (
                    ...
                    Tr.names.forEach(function (t) {
                        ...
                        n &&
                            n[e.getterName] &&
                            (i[e.privateName] = n[e.getterName]);
                    }),
            ...
            return (
                ...
                (e.prototype.trackCurrentTime = function () {
                    this.currentTimeInterval && this.stopTrackingCurrentTime(),
                        (this.currentTimeInterval = this.setInterval(
                            function () {
                                this.trigger({
                                    type: "timeupdate",
                                    target: this,
                ...
                (e.prototype.error = function (t) {
                    return (
                        void 0 !== t &&
                            ((this.error_ = new it(t)), this.trigger("error")),
                        this.error_
                    );
                }),
                        ...
                        s = function () {
                            ...
                            for (var t = 0; t < e.length; t++) {
                                ...
                                n.removeEventListener("cuechange", o),
                                    "showing" === n.mode &&
                                        n.addEventListener("cuechange", o);
                            }
                        };
                    s(),
                ...
                (e.prototype.addRemoteTextTrack = function () {
                    ...
                    return (
                        ...
                        !0 !== n &&
                            this.ready(function () {
                                return t.autoRemoteTextTracks_.addTrack(
                                    r.track
                                );
                            }),
                        r
                ...
                (e.prototype.removeRemoteTextTrack = function (t) {
                    var e =
                        this.remoteTextTrackEls().getTrackElementByTrack_(t);
                ...
                (e.isTech = function (t) {
                    return (
                        t.prototype instanceof e || t instanceof e || t === e
                    );
                }),
                (e.registerTech = function (t, n) {
                    if ((e.techs_ || (e.techs_ = {}), !e.isTech(n)))
    ...
    Tr.names.forEach(function (t) {
        ...
        Rr.prototype[e.getterName] = function () {
            return (
                (this[e.privateName] =
                    this[e.privateName] || new e.ListClass()),
                this[e.privateName]
            );
        };
    }),
        ...
        (Rr.withSourceHandlers = function (t) {
            (t.registerSourceHandler = function (e, n) {
                ...
                (t.canPlayType = function (e) {
                    for (
                        var n = t.sourceHandlers || [], r = void 0, i = 0;
                        i < n.length;
                        i++
                    )
                ...
                (t.prototype.setSource = function (e) {
                    ...
                    n ||
                        ...
                        (this.sourceHandler_ = n.handleSource(
                            e,
                            this,
                            this.options_
                        )),
    ...
    var Lr = {},
        ...
        Hr = (function (t) {
            function e(n, r, i) {
                Ie(this, e);
                var o = Q({ createEl: !1 }, r),
                    s = Re(this, t.call(this, n, o, i));
                if (
                    r.playerOptions.sources &&
                    0 !== r.playerOptions.sources.length
                )
                    n.src(r.playerOptions.sources);
                else
                    for (
                        var a = 0, l = r.playerOptions.techOrder;
                        a < l.length;
                        a++
                    ) {
                        var c = $(l[a]),
        ...
        return (
            ...
            (e.prototype.createEl = function () {
                ...
                (n = r(
                    ...
                    (i = r({ role: "button", "aria-live": "polite" }, i)),
    ...
    var zr = {
        ...
        Xr = (function (t) {
            function e(n, r, i) {
                ...
                return (
                    n.on("loadstart", ln(o, o.toggleDisplay)),
            ...
            return (
                ...
                (e.prototype.preselectTrack = function () {
                    for (
                        ...
                        var a = e[s];
                        n && n.enabled && n.language === a.language
                            ? a.kind === n.kind
                                ? (o = a)
                                : o || (o = a)
                            : n && !n.enabled
                ...
                (e.prototype.clearDisplay = function () {
                    "function" == typeof ie.WebVTT &&
                        ie.WebVTT.processCues(ie, [], this.el_);
                }),
                    ...
                    if ("function" == typeof ie.WebVTT && t.activeCues) {
                        ...
                        for (var i = n.length; i--; ) {
                            ...
                            if (o) {
                                ...
                                if (
                                    (e.color &&
                                        (s.firstChild.style.color = e.color),
                                    e.textOpacity &&
                                        Gt(
                                            s.firstChild,
                                            "color",
                                            Kt(e.color || "#fff", e.textOpacity)
                                        ),
                                    e.backgroundColor &&
                                ...
                                e.fontFamily &&
                                    ...
                                    ("small-caps" === e.fontFamily
                                        ? (s.firstChild.style.fontVariant =
                                              "small-caps")
                                        : (s.firstChild.style.fontFamily =
                                              zr[e.fontFamily]));
                            }
                        }
                    }
    ...
    var qr = (function (t) {
        function e() {
            return Ie(this, e), Re(this, t.apply(this, arguments));
        }
        return (
            De(e, t),
            (e.prototype.createEl = function () {
        ...
        return (
            ...
            (e.prototype.createEl = function (t) {
                ...
                (t = "button"),
                    ...
                    (n = r({ type: "button", "aria-live": "polite" }, n));
        ...
        return (
            ...
            (e.prototype.handleClick = function (t) {
                var e = this.player_.play(),
                    n = this.player_.getChild("controlBar"),
    ...
    var Yr = (function (t) {
        function e(n, r) {
            ...
            var i = Re(this, t.call(this, n, r));
            return (
                i.controlText((r && r.controlText) || i.localize("Close")), i
            );
        }
        return (
            De(e, t),
            (e.prototype.buildCSSClass = function () {
                return (
                    "vjs-close-button " + t.prototype.buildCSSClass.call(this)
                );
            }),
            (e.prototype.handleClick = function (t) {
    ...
    var $r = (function (t) {
        ...
        return (
            ...
            (e.prototype.buildCSSClass = function () {
                return (
                    "vjs-play-control " + t.prototype.buildCSSClass.call(this)
                );
            }),
            (e.prototype.handleClick = function (t) {
                this.player_.paused()
    ...
    var Jr = (function (t) {
        function e(n, r) {
            ...
            var i = Re(this, t.call(this, n, r));
            return (
                (i.throttledUpdateContent = cn(ln(i, i.updateContent), 25)),
        ...
        return (
            ...
            (e.prototype.updateTextNode_ = function () {
                this.textNode_ && this.contentEl_.removeChild(this.textNode_),
                    (this.textNode_ = ce.createTextNode(
            ...
            (e.prototype.updateContent = function (t) {
                var e = this.player_.scrubbing()
                    ...
                    n = Yt(e, this.player_.duration());
                n !== this.formattedTime_ &&
    ...
    var Qr = (function (t) {
        function e(n, r) {
            ...
            return (
                ...
                i.on(
                    n,
                    ["durationchange", "loadedmetadata", "timeupdate"],
                ...
                if (this.el_) {
                    ...
                    if (e) {
                        ...
                        var n = (100 * t).toFixed(2) + "%",
                            r = e.el().style;
                        return (
                            this.vertical() ? (r.height = n) : (r.width = n), t
                        );
                    }
                }
            }),
    ...
    var ri = (function (t) {
        ...
        return (
            ...
            (e.prototype.update = function (t) {
                ...
                for (var u = i.length; u > e.length; u--)
                    this.el_.removeChild(i[u - 1]);
                i.length = e.length;
            }),
            e
        );
    ...
    (oi.prototype.options_ = { children: [] }),
        (xe && !(xe > 8)) ||
            ye ||
            me ||
            oi.prototype.options_.children.push("timeTooltip"),
    ...
    (si.prototype.options_ = { children: ["timeTooltip"] }),
    ...
    (ai.prototype.options_ = {
        ...
        (xe && !(xe > 8)) ||
            ye ||
            me ||
            ai.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"),
    ...
    var li = (function (t) {
        function e(n, r) {
            ...
            var i = Re(this, t.call(this, n, r));
            return (
                (i.handleMouseMove = cn(ln(i, i.handleMouseMove), 25)),
    ...
    (li.prototype.options_ = { children: ["seekBar"] }),
    ...
    var di = (function (t) {
        function e(n) {
            ...
            Ie(this, e),
                ...
                (void 0 === r.volumeBar || o(r.volumeBar)) &&
    ...
    (di.prototype.options_ = { children: ["volumeBar"] }),
    ...
    var fi = (function (t) {
        function e(n, r) {
            ...
            var i = Re(this, t.call(this, n, r));
            return (
                ui(i, n), i.on(n, ["loadstart", "volumechange"], i.update), i
            );
        }
        return (
            De(e, t),
            (e.prototype.buildCSSClass = function () {
                return (
                    "vjs-mute-control " + t.prototype.buildCSSClass.call(this)
                );
            }),
            (e.prototype.handleClick = function (t) {
    ...
    var vi = (function (t) {
        function e(n) {
            ...
            Ie(this, e),
                ...
                (void 0 === r.volumeControl || o(r.volumeControl)) &&
    ...
    (vi.prototype.options_ = { children: ["muteToggle", "volumeControl"] }),
    ...
    var yi = (function (t) {
        ...
        return (
            ...
            (e.prototype.createEl = function () {
                ...
                (this.contentEl_ = f(e, { className: "vjs-menu-content" })),
        ...
        function e(n, r) {
            ...
            if (
                ...
                s.on(["tap", "click"], function () {
                    if ("object" !== Me(ie.Event))
                        try {
                            c = new ie.Event("change");
                        } catch (t) {}
                    c ||
                        ((c = ce.createEvent("Event")),
            ...
            (e.prototype.handleClick = function (e) {
                ...
                if ((r || (r = [n]), t.prototype.handleClick.call(this, e), i))
                    for (var o = 0; o < i.length; o++) {
                        var s = i[o];
                        s === this.track && r.indexOf(s.kind) > -1
        ...
        return (
            ...
            (e.prototype.handleSelectedLanguageChange = function (t) {
                for (
                    ...
                    var o = e[r];
                    if (
                        ["captions", "descriptions", "subtitles"].indexOf(
                            o.kind
                        ) > -1 &&
                        "showing" === o.mode
                    ) {
    ...
    var wi = (function (t) {
        function e(n, r, i) {
            return Ie(this, e), Re(this, t.call(this, n, r, i));
        }
        return (
            De(e, t),
            (e.prototype.buildCSSClass = function () {
            ...
            (e.prototype.update = function (e) {
                (this.track_ &&
                    (!e ||
                        ("addtrack" !== e.type && "removetrack" !== e.type))) ||
            ...
            (e.prototype.createItems = function () {
                ...
                return (
                    (this.player().tech_ &&
                        ...
                        (e.push(new xi(this.player_, { kind: this.kind_ })),
                        (this.hideThreshold_ += 1)),
        ...
        return (
            ...
            (e.prototype.createItems = function () {
                ...
                return (
                    (this.player().tech_ &&
                        this.player().tech_.featuresNativeTextTracks) ||
                        (e.push(new xi(this.player_, { kind: this.label_ })),
                        (this.hideThreshold_ += 1)),
    ...
    var Oi = (function (t) {
        ...
        return (
            ...
            (e.prototype.buildCSSClass = function () {
                return (
                    "vjs-audio-button " + t.prototype.buildCSSClass.call(this)
                );
            }),
            (e.prototype.buildWrapperCSSClass = function () {
                return (
            ...
            (e.prototype.createItems = function () {
                ...
                this.hideThreshold_ = 1;
                for (
                    var e = this.player_.audioTracks(), n = 0;
                    n < e.length;
                    n++
                ) {
                    var r = e[n];
    ...
    var Mi = (function (t) {
        function e(n, r) {
            ...
            var s = Re(this, t.call(this, n, r));
            return (
                (s.label = i), (s.rate = o), s.on(n, "ratechange", s.update), s
            );
        }
        return (
            De(e, t),
    ...
    var Ii = (function (t) {
        ...
        return (
            ...
            (e.prototype.buildCSSClass = function () {
                return (
                    "vjs-playback-rate " + t.prototype.buildCSSClass.call(this)
                );
            }),
            (e.prototype.buildWrapperCSSClass = function () {
                return (
            ...
            (e.prototype.createMenu = function () {
                ...
                if (e)
                    for (var n = e.length - 1; n >= 0; n--)
                        t.addChild(new Mi(this.player(), { rate: e[n] + "x" }));
                return t;
            }),
    ...
    var Bi = (function (t) {
        ...
        return (
            ...
            (e.prototype.buildCSSClass = function () {
                return (
                    "vjs-error-display " + t.prototype.buildCSSClass.call(this)
                );
            }),
    ...
    var Ji = (function (t) {
        function r(n, i) {
            ...
            return (
                (o.updateDisplay = ln(o, o.updateDisplay)),
                o.fill(),
        ...
        return (
            ...
            (r.prototype.restoreSettings = function () {
                ...
                try {
                    t = JSON.parse(
                        ie.localStorage.getItem("vjs-text-track-settings")
                    );
                } catch (t) {
                    ze.warn(t);
                }
        ...
        Zi = (function (t) {
            function e(n, r) {
                ...
                if (
                    ...
                    for (
                        var a = i.el_.childNodes, l = a.length, c = [];
                        l--;
            ...
            return (
                ...
                (e.prototype.proxyNativeTracks_ = function () {
                    ...
                    _r.names.forEach(function (e) {
                        var n = _r[e],
                            ...
                            i = t[n.getterName]();
                        if (
                            t["featuresNative" + n.capitalName + "Tracks"] &&
                            r &&
                            r.addEventListener
                        ) {
                            var o = {
                    ...
                    if (
                        ...
                        if (t) {
                            ...
                            var i = this.options_.tag && C(this.options_.tag),
                                o = Q({}, i);
                            (Pe &&
                                !0 === this.options_.nativeControlsForTouch) ||
                                delete o.controls,
                                T(
                                    t,
                                    r(o, {
                ...
                (e.prototype.addTextTrack = function (e, n, r) {
                    return this.featuresNativeTextTracks
                        ? this.el_.addTextTrack(e, n, r)
                        : t.prototype.addTextTrack.call(this, e, n, r);
                }),
                ...
                (e.prototype.getVideoPlaybackQuality = function () {
                    ...
                    return (
                        ...
                        ie.performance &&
                        "function" == typeof ie.performance.now
                            ? (t.creationTime = ie.performance.now())
                            : ie.performance &&
                              ie.performance.timing &&
                              "number" ==
                                  typeof ie.performance.timing
                                      .navigationStart &&
                              (t.creationTime =
                                  ie.Date.now() -
                                  ie.performance.timing.navigationStart),
                        t
                    );
                }),
                e
    ...
    (Zi.isSupported = function () {
        ...
        (Zi.canControlVolume = function () {
            try {
                ...
                return (
                    (Zi.TEST_VID.volume = t / 2 + 0.1), t !== Zi.TEST_VID.volume
                );
            } catch (t) {
                return !1;
            }
        ...
        (Zi.canControlPlaybackRate = function () {
            ...
            try {
                ...
                return (
                    (Zi.TEST_VID.playbackRate = t / 2 + 0.1),
        ...
        (Zi.prototype.featuresNativeVideoTracks =
            Zi.supportsNativeVideoTracks()),
        (Zi.prototype.featuresNativeAudioTracks =
    ...
    (Zi.patchCanPlayType = function () {
        _e >= 4 && !Ce
            ? (Zi.TEST_VID.constructor.prototype.canPlayType = function (t) {
    ...
    var io = Le(
        ...
        so = (function (t) {
            function e(n, i, o) {
                if (
                    (Ie(this, e),
                    (n.id = n.id || "vjs_video_" + R()),
                    (i = r(e.getTagSettings(n), i)),
                    (i.initChildren = !1),
                    (i.createEl = !1),
                ...
                if (
                    ((l.isReady_ = !1),
                    !l.options_ ||
                        !l.options_.techOrder ||
                        !l.options_.techOrder.length)
                )
                    throw new Error(
                ...
                if (
                    ((l.tag = n),
                    (l.tagAttributes = n && C(n)),
                    l.language(l.options_.language),
                    i.languages)
                ) {
                    var c = {};
                    Object.getOwnPropertyNames(i.languages).forEach(function (
                        t
                    ) {
                ...
                (l.options_.playerOptions = u),
                    ...
                    l.isAudio()
                        ? l.el_.setAttribute(
                              "aria-label",
                              l.localize("Audio Player")
                          )
                        : l.el_.setAttribute(
                              "aria-label",
                              l.localize("Video Player")
                          ),
            ...
            return (
                ...
                (e.prototype.createEl = function () {
                    ...
                    for (
                        var a = e.getElementsByTagName("a"), l = 0;
                        l < a.length;
                        l++
                    ) {
                        var c = a.item(l);
                ...
                (e.prototype.loadTech_ = function (t, e) {
                    ...
                    "Html5" !== i &&
                        this.tag &&
                        (Rr.getTech("Html5").disposeMediaElement(this.tag),
                ...
                (e.prototype.unloadTech_ = function () {
                    ...
                    Tr.names.forEach(function (e) {
                        ...
                        (this.textTracksJson_ = On.textTracksToJson(
                            this.tech_
                        )),
                        (this.isReady_ = !1),
                        this.tech_.dispose(),
                ...
                (e.prototype.techCall_ = function (t, e) {
                    this.ready(function () {
                        if (t in Fr)
                            return zt(this.middleware_, this.tech_, t, e);
                        try {
                ...
                (e.prototype.currentTime = function (t) {
                    return void 0 !== t
                        ? void this.techCall_("setCurrentTime", t)
                ...
                (e.prototype.volume = function (t) {
                    ...
                    return void 0 !== t
                        ...
                        : ((e = parseFloat(this.techGet_("volume"))),
                          isNaN(e) ? 1 : e);
                }),
                    ...
                    this.isFullscreen(!0),
                        t.requestFullscreen
                            ? (U(
                                  ce,
                                  t.fullscreenchange,
                                  ln(this, function e(n) {
                                      this.isFullscreen(
                                          ce[t.fullscreenElement]
                                      ),
                                          !1 === this.isFullscreen() &&
                                              z(ce, t.fullscreenchange, e),
                                          this.trigger("fullscreenchange");
                                  })
                              ),
                ...
                (e.prototype.enterFullWindow = function () {
                    (this.isFullWindow = !0),
                        (this.docOrigOverflow =
                            ce.documentElement.style.overflow),
                ...
                (e.prototype.canPlayType = function (t) {
                    for (
                        var e = void 0, n = 0, r = this.options_.techOrder;
                        n < r.length;
                        n++
                    ) {
                        var i = r[n],
                        ...
                        if ((o || (o = bn.getComponent(i)), o)) {
                            if (o.isSupported() && (e = o.canPlayType(t)))
                                return e;
                        } else
                            ze.error(
                                'The "' +
                ...
                (e.prototype.src = function (t) {
                    ...
                    (this.cache_.sources = n),
                        ...
                        Ht(this, n[0], function (t, r) {
                            if (((e.middleware_ = r), e.src_(t)))
                                return n.length > 1
                                    ? e.src(n.slice(1))
                ...
                (e.prototype.error = function (t) {
                    return void 0 === t
                        ...
                        : ((this.error_ = new it(t)),
                          this.addClass("vjs-error"),
                          ze.error(
                              "(CODE:" +
                                  this.error_.code +
                                  " " +
                                  it.errorTypes[this.error_.code] +
                                  ")",
                              this.error_.message,
                              this.error_
                          ),
                ...
                (e.prototype.listenForUserActivity_ = function () {
                    var t = void 0,
                        ...
                        i = function (t) {
                            (t.screenX === e && t.screenY === n) ||
                                ((e = t.screenX), (n = t.screenY), r());
                        },
                        o = function () {
                            r(),
                ...
                (e.getTagSettings = function (t) {
                    ...
                    if ((r(e, n), t.hasChildNodes()))
                        for (
                            var l = t.childNodes, c = 0, u = l.length;
                            c < u;
                            c++
                        ) {
                            var h = l[c],
    ...
    var lo = {},
        ...
        fo = function (t, e) {
            var n = function () {
                ...
                return (
                    ho(this, t),
                    po(this, { name: t, plugin: e, instance: n }),
                    n
                );
            };
            return (
        ...
        yo = (function () {
            function t(e) {
                if ((Ie(this, t), this.constructor === t))
                    throw new Error(
            ...
            return (
                ...
                (t.isBasic = function (e) {
                    ...
                    return (
                        "function" == typeof n &&
                        !t.prototype.isPrototypeOf(n.prototype)
                    );
                }),
                (t.registerPlugin = function (e, n) {
                    ...
                    else if (so.prototype.hasOwnProperty(e))
                        throw new Error(
                            'Illegal plugin name, "' +
                                e +
                    ...
                    return (
                        ...
                        "plugin" !== e &&
                            (t.isBasic(n)
                                ? (so.prototype[e] = fo(e, n))
                                : (so.prototype[e] = vo(e, n))),
                        n
                    );
                }),
    ...
    if (
        ("undefined" == typeof HTMLVideoElement &&
            h() &&
            (ce.createElement("video"),
            ce.createElement("audio"),
            ce.createElement("track")),
        (Zt.hooks_ = {}),
        (Zt.hooks = function (t, e) {
            return (
                (Zt.hooks_[t] = Zt.hooks_[t] || []),
        ...
        (Zt.removeHook = function (t, e) {
            ...
            return (
                !(n <= -1) &&
                ((Zt.hooks_[t] = Zt.hooks_[t].slice()),
                Zt.hooks_[t].splice(n, 1),
                !0)
            );
        }),
    ...
    return (
        ...
        (Zt.addLanguage = function (t, e) {
            ...
            return (
                (t = ("" + t).toLowerCase()),
                (Zt.options.languages = Q(
                    Zt.options.languages,
                    ((n = {}), (n[t] = e), n)
                )),

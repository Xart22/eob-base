...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form
                    action="{{ route('news.update',$detil_data->uuid) }}"
                    method="post"
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="news_headline"
                                    required
                                    value="{{$detil_data->news_headline }}"
                                    autocomplete="off"
                                />
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea
                                    name="news_content"
                                    id="summernote"
                                    >{{$detil_data->news_content}}</textarea
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input
                                ...
                                required
                                value="{{ $detil_data->news_source_link }}"
                                autocomplete="off"
                            />
                        </div>
                    </div>

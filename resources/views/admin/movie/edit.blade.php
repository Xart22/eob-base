...
@section('title','Dashboard')@section('breadcrumb','Movie')@section('header')
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form
                    action="{{ route('movie.update',$detil_data->uuid) }}"
                    method="post"
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="movie_director"
                                    required
                                    value="{{ $detil_data->movie_director }}"
                                    autocomplete="off"
                                />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea
                                ...
                                rows="4"
                                name="movie_desc"
                                >{{$detil_data->movie_desc}}</textarea
                            >
                        </div>
                    </div>

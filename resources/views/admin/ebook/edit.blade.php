...
@section('title','e-Book')@section('breadcrumb','e-Book')@section('header')
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form
                    action="{{ route('ebook.update',$detil_data->uuid) }}"
                    method="post"
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h4 class="card-title">e-Books List</h4>
            </div>
            <div class="card-body">
